...
makeButton("- Fly Speed -10",  120, function()
	flySpeed-=10
	log.Text = log.Text.."[FLY] Speed now "..flySpeed.."\n"
end)

makeButton("➕ Jump Power +10",160, function()
	jumpPower+=10
	if humanoid and jumpBoost then humanoid.JumpPower = jumpPower end
	log.Text = log.Text.."[JUMP] Power now "..jumpPower.."\n"
end)

makeButton("📂 Toggle ShopGui",200, function()
...
makeButton("⇄ Teleport Player", 280, function()
...
makeButton("📍 Click TP", 320, function()
	clickTP = not clickTP
	log.Text = log.Text
		.. "[TP] Click TP "
...
makeButton("⇑ Infinite Jump", 360, function()
...
local sliderY = 400  -- change as needed
...
sliderFrame.Size                   = UDim2.new(0, 400, 0, 40)
...
makeButton("☢ Toggle ESP", 440, function()
...
makeButton("☵ Toggle Noclip", 480, function()
...
-- 👑 VIP Access Panel (Input Embedded in Wrapper)

local function makeButton(label, yOffset, callback)
...
vipGui.Name = "VIPAccess"
vipGui.ResetOnSpawn = false

-- 🪟 Main Frame
local wrapper = Instance.new("Frame", vipGui)
wrapper.Active = true
wrapper.Draggable = true
wrapper.Name = "VIPWrapper"
wrapper.Size = UDim2.new(0, 540, 0, 280)
wrapper.Position = UDim2.new(0.5, -230, 0.5, -140)
...
title.Text = "🔐 Enter VIP Code to Unlock Features"
title.TextColor3 = Color3.fromRGB(0, 255, 0)
title.Font = Enum.Font.Code
title.TextScaled = true
title.BackgroundTransparency = 1
...
box.PlaceholderText = "Enter VIP code..."
box.TextColor3 = Color3.fromRGB(0, 255, 0)
...
btn.Position = UDim2.new(0.25, 0, 0, 95)
btn.Text = "Unlock VIP"
btn.TextColor3 = Color3.fromRGB(0, 255, 0)
btn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
btn.Font = Enum.Font.Code
...
-- 👁 Premium Panel (starts hidden)
local premium = Instance.new("Frame", wrapper)
premium.Name = "PremiumPanel"
premium.Size = UDim2.new(0.9, 0, 0, 100)
premium.Position = UDim2.new(0.05, 0, 0, 140)
premium.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
premium.Visible = false
Instance.new("UICorner", premium).CornerRadius = UDim.new(0, 12)

-- 💬 TP Input Box
local tpInput = Instance.new("TextBox", premium)
tpInput.Size = UDim2.new(0.58, 0, 0, 28)
tpInput.Position = UDim2.new(0.05, 0, 0, 10)
...
-- 🚀 TP Button
local tpBtn = Instance.new("TextButton", premium)
tpBtn.Size = UDim2.new(0.32, 0, 0, 28)
tpBtn.Position = UDim2.new(0.63, 0, 0, 10)
...
btn.MouseButton1Click:Connect(function()
	...
	if input == "00753" then
		...
		box.Text = ""
		box.PlaceholderText = "✅ Access Granted"
		btn.Text = "Welcome!"
	else
		box.Text = ""
		box.PlaceholderText = "❌ Invalid Code"
	end
end)
...
tpBtn.MouseButton1Click:Connect(function()
	...
	if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
		...
		if myRoot then
			...
			tpInput.Text = ""
			tpInput.PlaceholderText = "✅ Teleported!"
		end
	else
		tpInput.Text = ""
		tpInput.PlaceholderText = "❌ Player not found"
	end
end)

-- 🎁 Give Items Button
local giveBtn = Instance.new("TextButton", premium)
giveBtn.Size = UDim2.new(0.9, 0, 0, 28)
giveBtn.Position = UDim2.new(0.05, 0, 0, 50)
giveBtn.Text = "Get All Items"
giveBtn.TextColor3 = Color3.fromRGB(0, 255, 0)
giveBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
giveBtn.Font = Enum.Font.Code
...
giveBtn.MouseButton1Click:Connect(function()
	...
	local function cloneToolsFrom(source)
	...
	cloneToolsFrom(game:GetService("StarterPack"))

	tpInput.PlaceholderText = "✅ Items granted!"
end)
...
makeButton("Toggle VIP Panel", 240, function()
	if vipGui then
		vipGui.Enabled = not vipGui.Enabled
	end
end)

-- 🛸 TP Tool Button (inside premium)
local tpToolBtn = Instance.new("TextButton", premium)
tpToolBtn.Size = UDim2.new(0.9, 0, 0, 28)
tpToolBtn.Position = UDim2.new(0.05, 0, 0, 85)
tpToolBtn.Text = "TP Tool"
tpToolBtn.TextColor3 = Color3.fromRGB(0, 255, 0)
tpToolBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
tpToolBtn.Font = Enum.Font.Code
tpToolBtn.TextScaled = true
...
tpToolBtn.MouseButton1Click:Connect(function()
	...
	tpInput.PlaceholderText = "✅ TP Tool Granted!"
end)
